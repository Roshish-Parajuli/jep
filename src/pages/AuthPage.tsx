...
import { Loader2, Mail, Lock, ArrowRight } from 'lucide-react'; // Assuming Lucide is available
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleAuth} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 rounded-lg font-medium hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            className="mt-6 w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-2 rounded-lg hover:bg-gray-50 transition-colors font-medium"
                        >
                    ...
                    <p className="mt-8 text-center text-sm text-gray-600">
                        ...
                        <button
                            ...
                            className="text-purple-600 hover:text-purple-700 font-medium font-semibold"
                        >
