        ...
        {activeTab === 'valentine' ? (
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h2 className="text-2xl font-bold text-slate-900">Digital Gift Pages</h2>
                <p className="text-slate-500 text-sm">Personalized interactive gift pages created by users.</p>
              </div>
              <button
              ...
              >
                <Plus size={20} />
                <span>Create New Digital Gift</span>
              </button>
            </div>
            ...
            {!loading && !error && pages.length === 0 && (
              <p className="text-center text-slate-500 py-12 px-4 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                No Digital Gift pages created yet.
              </p>
            )}
